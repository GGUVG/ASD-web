...
export function findBySearch (pageReq) {
    return request(('http://localhost:9091/v1/house/forRent/findPageHouseForRent'), {
      method: 'POST',
      data: pageReq
    })
  }
...
export function exportBySearch (pageReq) {
    return exportRequest(('http://localhost:9091/v1/house/forRent/exportFindHouseForRent'), {
      method: 'POST',
      data: pageReq,
